...
from trains.singleTask.model.ldm.modules.diffusionmodules.util import make_ddim_sampling_parameters, make_ddim_timesteps, noise_like
...
class DDIMSampler(object):
    ...
    def ddim_sampling(self, cond, shape,
        ...
        # 在采样过程中，根据当前时间步选择是否进行掩码融合，并在图像生成过程中应用相应的掩码。
        ...
        for i, step in enumerate(iterator):
            ...
            # 如果提供了blend_interval，则在不同的时间步中应用不同的掩码和初始图像。这些掩码和初始图像通过插值方式混合，以实现逐步的图像修复。
            if blend_interval is not None:
